...
SOURCES += qommunicate.cpp main.cpp settings.cpp messagedialog.cpp membermodel.cpp messenger.cpp fileutils.cpp memberutils.cpp transferdialogs.cpp sendfileprogressdialog.cpp recvfileprogressdialog.cpp
